defmodule TodoApi.AccountsTest do
  ...
  describe "users" do
    ...
    test "create_user/1 with valid data creates a user" do
      ...
      assert true == Argon2.verify_pass("some hashed_password", user.hashed_password)
    end
    ...
    test "update_user/2 with valid data updates the user" do
      ...
      assert true == Argon2.verify_pass("some updated hashed_password", user.hashed_password)
    end
